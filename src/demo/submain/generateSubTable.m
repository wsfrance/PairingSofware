...
rankTable = table(...
    ...
    zerosMat,...
    'VariableName', {'Points', 'PointsOfTop', 'Ranking', 'winNumber', 'tieNumber', 'lossNumber', 'Modified_Median', 'Solkoff' , 'Cumulative_Score', 'first_Loss', 'Buchholz', 'MWP', 'Opp_MW', 'Opp_T1','historyPoints', 'boolDropped'});
