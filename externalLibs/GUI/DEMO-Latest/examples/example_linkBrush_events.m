...
%
% $Id: example_linkBrush_events.m 264 2016-02-01 10:10:38Z robertcumming $
function hGui = example_linkBrush_events ()
  ...
  hPlot2 = plot ( axes1, hGui.data.X, hGui.data.Z, 'go' );
